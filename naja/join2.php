...
<body>
    ...
    <h1>Soal Join 2 Ihdiannaja</h1>
        ...
        <?php
            ...
            // select all data
            $query = "SELECT id_penyewa, nama_penyewa, id_denda
                      FROM PENYEWA P JOIN transaksi T USING(id_penyewa) JOIN ditambah dt USING(id_transaksi);";
